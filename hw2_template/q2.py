...
"""
2(d)
For MCCV, as the portion of the dataset to serve as a holdout increased, both the validation and the time elapsed increased.
For k-fold CV, as the number of folds or groups increased, both the validation and the time elapsed increased.
